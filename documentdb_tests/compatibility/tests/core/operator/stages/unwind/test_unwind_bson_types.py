"""Tests for $unwind stage — BSON type preservation and scalar passthrough."""
...
UNWIND_BSON_ALL_TESTS = UNWIND_BSON_TYPE_TESTS + UNWIND_SCALAR_PASSTHROUGH_TESTS


@pytest.mark.aggregate
@pytest.mark.parametrize("test_case", pytest_params(UNWIND_BSON_ALL_TESTS))
def test_unwind_bson_types(collection, test_case: StageTestCase):
    """Test $unwind BSON type preservation and scalar passthrough."""
