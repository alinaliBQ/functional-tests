...
# Aliases for $group-specific error codes that share numbers with $bucket
GROUP_ACCUMULATOR_INVALID_VALUE_ERROR = BUCKET_OUTPUT_NOT_ACCUMULATOR_ERROR
GROUP_ACCUMULATOR_DOT_FIELD_NAME_ERROR = BUCKET_OUTPUT_DOT_ERROR
GROUP_ACCUMULATOR_DOLLAR_FIELD_NAME_ERROR = BUCKET_OUTPUT_DOLLAR_PREFIX_ERROR
MISSING_REQUIRED_FIELD_ERROR = MISSING_FIELD_ERROR
CLUSTER_TIME_STANDALONE_ERROR = CLUSTER_TIME_NOT_AVAILABLE_ERROR
