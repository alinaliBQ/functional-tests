...
BASIC_TESTS: list[ArrayTestClass] = [
    ArrayTestClass(
        id="two_int_arrays",
        arrays=[[1, 2], [3, 4]],
        expected=[1, 2, 3, 4],
...
EMPTY_TESTS: list[ArrayTestClass] = [
    ArrayTestClass(
        id="both_empty",
        arrays=[[], []],
        expected=[],
...
SINGLE_ARRAY_TESTS: list[ArrayTestClass] = [
    ArrayTestClass(
        id="single_array",
        arrays=[[1, 2, 3]],
        expected=[1, 2, 3],
...
NESTED_ARRAY_TESTS: list[ArrayTestClass] = [
    ArrayTestClass(
        id="nested_subarrays",
        arrays=[[[1, 2]], [[3, 4]]],
        expected=[[1, 2], [3, 4]],
...
DUPLICATE_TESTS: list[ArrayTestClass] = [
    ArrayTestClass(
...
OBJECT_TESTS: list[ArrayTestClass] = [
    ArrayTestClass(
...
MANY_ARRAYS_TESTS: list[ArrayTestClass] = [
    ArrayTestClass(
        id="five_arrays",
        arrays=[[1], [2], [3], [4], [5]],
        expected=[1, 2, 3, 4, 5],
