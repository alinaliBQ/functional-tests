...
# ---------------------------------------------------------------------------
# Success: out-of-bounds index → no result (returns nothing / missing)
# ---------------------------------------------------------------------------
OUT_OF_BOUNDS_TESTS: list[ArrayElemAtTest] = [
    ArrayElemAtTest(
        ...
        idx=15,
        expected=[{}],
        msg="Should return no result for positive OOB",
    ),
    ArrayElemAtTest(
        ...
        idx=3,
        expected=[{}],
        msg="Should return no result for OOB by one",
    ),
    ArrayElemAtTest(
        id="negative_oob",
        array=[1, 2, 3],
        idx=-4,
        expected=[{}],
        msg="Should return no result for negative OOB",
    ),
    ArrayElemAtTest(
        ...
        idx=-100,
        expected=[{}],
        msg="Should return no result for large negative OOB",
    ),
    ArrayElemAtTest(
        ...
        idx=0,
        expected=[{}],
        msg="Should return no result for empty array idx 0",
    ),
    ArrayElemAtTest(
        id="empty_array_neg1",
        array=[],
        idx=-1,
        expected=[{}],
        msg="Should return no result for empty array idx -1",
    ),
    ArrayElemAtTest(
        id="int32_max_oob",
        array=[1, 2, 3],
        idx=INT32_MAX,
        expected=[{}],
        msg="Should return no result for INT32_MAX index",
    ),
    ArrayElemAtTest(
        id="int32_min_oob",
        array=[1, 2, 3],
        idx=INT32_MIN,
        expected=[{}],
        msg="Should return no result for INT32_MIN index",
    ),
    ArrayElemAtTest(
        ...
        idx=1,
        expected=[{}],
        msg="Should return no result for single element OOB positive",
    ),
    ArrayElemAtTest(
        ...
        idx=-2,
        expected=[{}],
        msg="Should return no result for single element OOB negative",
    ),
    ArrayElemAtTest(
        ...
        idx=Decimal128("15"),
        expected=[{}],
        msg="Should return no result for Decimal128 positive OOB",
    ),
    ArrayElemAtTest(
        ...
        idx=Decimal128("-100"),
        expected=[{}],
        msg="Should return no result for Decimal128 negative OOB",
    ),
]

TEST_SUBSET_FOR_LITERAL = [
    OUT_OF_BOUNDS_TESTS[0],  # positive_oob
    OUT_OF_BOUNDS_TESTS[4],  # empty_array_idx_0
    OUT_OF_BOUNDS_TESTS[-1],  # decimal128_oob_neg
]
