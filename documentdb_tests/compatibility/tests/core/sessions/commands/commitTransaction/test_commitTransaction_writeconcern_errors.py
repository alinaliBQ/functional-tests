"""Tests for commitTransaction writeConcern rejected values.

Validates that writeConcern rejects non-document types with TypeMismatch, and
that sub-fields w, j, and wtimeout reject invalid types and values.
"""
...
def test_commitTransaction_writeconcern_errors(collection, test):
    """Test commitTransaction writeConcern rejected values."""
