"""Tests for commitTransaction writeConcern accepted values.

Validates that writeConcern accepts document values, and that sub-fields w, j,
and wtimeout accept their respective valid types and values.
"""
...
def test_commitTransaction_writeconcern(collection, test):
    """Test commitTransaction writeConcern accepted values."""
